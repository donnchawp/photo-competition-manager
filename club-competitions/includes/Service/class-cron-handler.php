...
class Cron_Handler {
	...
	public function register(): void {
		if ( ! wp_next_scheduled( 'club_competitions_daily_cron' ) ) {
			wp_schedule_event( time(), 'daily', 'club_competitions_daily_cron' );
		}

		add_action( 'club_competitions_daily_cron', array( $this, 'update_competition_statuses' ) );
	}
